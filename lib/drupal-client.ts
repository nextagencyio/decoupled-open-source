            ...
            route(path: $path) {
              ... on RouteInternal {
                entity {
                  ...
                  ... on NodeHomepage { __typename id title path heroTitle heroSubtitle heroDescription { processed } featuresTitle featuresSubtitle ctaTitle ctaDescription { processed } ctaPrimary ctaSecondary }
                }
              }
            }
          }
